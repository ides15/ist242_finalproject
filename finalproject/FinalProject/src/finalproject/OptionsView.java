...
public class OptionsView extends JPanel {
    ...
    public OptionsView(OptionsModel optionsModel) {
        ...
        backgroundColorLabel.setBounds(250, 50, 120, 30);
        add(redButton);
        redButton.setBounds(400, 50, 75, 30);
        add(blueButton);
        blueButton.setBounds(500, 50, 75, 30);
        add(greenButton);
        greenButton.setBounds(600, 50, 75, 30);
        
        add(fontSizeLabel);
        fontSizeLabel.setBounds(250, 100, 150, 50);
        add(fontSize);
        fontSize.setBounds(400, 100, 250, 50);
        
        add(pageSizeLabel);
        pageSizeLabel.setBounds(250, 175, 150, 50);
        add(pageSize);
        pageSize.setBounds(400, 175, 250, 50);
        
        add(saveButton);
        saveButton.setBounds(250, 250, 100, 30);
        add(summaryLabel);
        summaryLabel.setBounds(400, 250, 600, 30);
